...
public class Router {
	...
	public static void configure() {
		...
		Spark.get("/proyecto/condicionComparativa/new", CondicionComparativaController::nuevo, engine);
		Spark.get("/proyecto/condicionTaxativa/new", CondicionTaxativaController::nuevo, engine);
